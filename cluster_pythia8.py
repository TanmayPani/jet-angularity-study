...
from _pdgid_utils import charge
...
def cluster_batch(events, jet_definition, con_kt_min=0.2, hc_kt_min=2.0, cs_pt_min=2.0, do_hc_mode=True):
    ...
    jets_, constituents_ = _utils.inclusive_jets_sorted_by_pt(cluster_seq_, min_pt=cs_pt_min)
    jets_, constituents_ = _utils.process_jets(
    ...
    return _utils.jets_to_rb_dict(jets_, constituents_, do_hc_mode=do_hc_mode)
